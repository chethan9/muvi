      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => ProcessingWidget(
            processingmagnet:
                params.getParam('processingmagnet', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'player',
        ...
        FFRoute(
          ...
          builder: (context, params) => HomePageWidget(
            movieselected: params.getParam('movieselected', ParamType.String),
            moviesearched: params.getParam('moviesearched', ParamType.String),
          ),
        )
